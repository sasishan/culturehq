<template>
<div>
  Sort by:  <Culture_Sort_Dropdown class="ml-2" @sortBy="selectSort" @sortDirectionChanged="selectSortDirection" :selectedSortField="selectedSortField" :sortDirectionStart="selectedSortFieldDirection"/>
      ...
      <div class="card sharp-card shadow-sm mt-3 mb-4"  data-toggle="modal" data-target="#questionDetailsModal" @click="showQuestionDetails(surveyQuestion)">
        <div class="card-header">
          ...
          <small>        
            ...
            <br>{{surveyQuestion.lastSent | moment("ddd DD MMM")}}  
          </small>                    
        </div>
